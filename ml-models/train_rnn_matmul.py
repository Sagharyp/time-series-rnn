...
from custom_simplernn import SimpleRNN  # Import your custom SimpleRNN from try1.py
...
model.save("SimpleRNN_model_rm_relu.h5")
...
plt.savefig('confusion_matrix_rm_relu.png')  # Save Confusion Matrix plot (For server use)
...
plt.xlabel('Epoch')
plt.ylabel('Accuracy')
plt.savefig('accuracy_plot_rm_relu.png')  # Save accuracy plot (For server use)
...
def generate_test_vectors():
    ...
    with open('simplernn_test_vectors_rm_relu.v', 'w') as f:
