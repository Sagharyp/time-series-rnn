...
# Usage in your model (replace keras.layers.BatchNormalization):
def create_model_with_custom_batchnorm(window_size, num_features, num_classes):
    """
    Example of using your custom BatchNormalization
    """
    from Saghar.train_rnn_matmul import SimpleRNN  # Your custom SimpleRNN
    ...
    model = tf.keras.Sequential([
        ...
        BatchNormalization(),  # Your custom BatchNorm
